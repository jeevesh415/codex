...
When `outputSchema` is set, Codex asks the model for a strict JSON final answer matching that schema. This constrains only the final assistant message for the turn.
